...
function changeTeam() {
    ...
    var tm_url = 'http://www.transfermarkt.at/de/nationalmannschaft/'+__teams[team_id]['tm_id']+'/'+__teams[team_id]['tm_name']+'/uebersicht/startseite.print';
    document.administration_form.playermanagement_tm_url.value = tm_url;
}
...
function loadSite() {
    ...
    var url = server + 'administration/playermanagement/loadPlayerlistFromUrl.xml';
    new Ajax.Request(url, {
 		onSuccess : function(response) {
 		var xmlResponse=response.responseXML;
