...
function dispMatchInfo(match_id) {
	...
	new Ajax.Request(url, {
        ...
        match_data['match_minutes'] = parseInt(matchdata[0].getElementsByTagName('match_minutes')[0].firstChild.nodeValue);
        ...
        if(homeplayer_data.length>0) {
        	//alert(match_data['match_minutes']);
...
function calculateHometeam(hometeam, match_minutes) {
    ...
    for(var i=0; i<hometeam.length; i++) {
        ...
        var minutes_in = parseInt(hometeam[i].getElementsByTagName('player_playerstats_minute_in')[0].firstChild.nodeValue);
        var minutes_out = parseInt(hometeam[i].getElementsByTagName('player_playerstats_minute_out')[0].firstChild.nodeValue);
...
function calculateGuestteam(guestteam, match_minutes) {
    ...
    for(var i=0; i<guestteam.length; i++) {
        ...
        var minutes_in = parseInt(guestteam[i].getElementsByTagName('player_playerstats_minute_in')[0].firstChild.nodeValue);
        var minutes_out = parseInt(guestteam[i].getElementsByTagName('player_playerstats_minute_out')[0].firstChild.nodeValue);
