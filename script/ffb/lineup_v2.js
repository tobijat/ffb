...
function dispTeamSelection() {
    ...
    for(var i=0;i<_teams.length;i++) {
        team_select += '<option class="ffb_select_' + i%2 + '" value="' + i + '">';
...
function dispPlayerList(team_id) {
    ...
    selectTeamPlayer += '<div id="playerlisttrend" title="Tendenz"><b>T.</b></div><div id="playerlistname" style="text-align:center;" title="Name"><b>Name</b></div><div id="playerlistprice" title="Preis"><b>Preis</b></div><div id="playerliststatus" title="Status"><b>St.</b></div><div id="playerlistinfo" title="Spieler-Infos"><b>Info</b></div><div class="playergrade" title="Leistung"><b>Leistung</b></div></div>';
