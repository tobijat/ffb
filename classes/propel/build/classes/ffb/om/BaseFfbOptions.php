...
abstract class BaseFfbOptions extends BaseObject  implements Persistent
{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(FfbOptionsPeer::OPTIONS_ID) ) {
	...
	{
		$pos = FfbOptionsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getOptionsGameId();
				break;
			case 2:
				return $this->getOptionsScoreMinutes();
				break;
			case 3:
				return $this->getOptionsScoreMinutesTreshold();
				break;
			case 4:
				return $this->getOptionsScoreMinutesGt();
				break;
			case 5:
				return $this->getOptionsScoreMinutesLt();
				break;
			case 6:
				return $this->getOptionsScoreMinutesLt30();
				break;
			case 7:
				return $this->getOptionsScoreGoalsG();
				break;
			case 8:
				return $this->getOptionsScoreGoalsD();
				break;
			case 9:
				return $this->getOptionsScoreGoalsM();
				break;
			case 10:
				return $this->getOptionsScoreGoalsS();
				break;
			case 11:
				return $this->getOptionsScoreAssists();
				break;
			case 12:
				return $this->getOptionsScoreNoOppgoalsG();
				break;
			case 13:
				return $this->getOptionsScoreNoOppgoalsD();
				break;
			case 14:
				return $this->getOptionsScoreNoOppgoalsM();
				break;
			case 15:
				return $this->getOptionsScoreOppgoalsG();
				break;
			case 16:
				return $this->getOptionsScoreOppgoalsD();
				break;
			case 17:
				return $this->getOptionsScoreOwngoals();
				break;
			case 18:
				return $this->getOptionsScoreCardY();
				break;
			case 19:
				return $this->getOptionsScoreCardR();
				break;
			case 20:
				return $this->getOptionsScoreCardYr();
				break;
			case 21:
				return $this->getOptionsScorePenaltySaved();
				break;
			case 22:
				return $this->getOptionsScorePenaltyLost();
				break;
			case 23:
				return $this->getOptionsScorePenaltyshootoutSave();
				break;
			case 24:
				return $this->getOptionsScorePenaltyshootoutLost();
				break;
			case 25:
				return $this->getOptionsScorePenaltyshootoutHit();
				break;
			case 26:
				return $this->getOptionsScoreHighLoss();
				break;
			case 27:
				return $this->getOptionsScoreHighWin();
				break;
			case 28:
				return $this->getOptionsScoreHighWinLossTreshold();
				break;
			case 29:
				return $this->getOptionsStatusError();
				break;
			case 30:
				return $this->getOptionsStatusErrorValidation();
				break;
			case 31:
				return $this->getOptionsStatusSuccess();
				break;
			case 32:
				return $this->getOptionsStatusSuccessInsert();
				break;
			case 33:
				return $this->getOptionsStatusSuccessUpdate();
				break;
			case 34:
				return $this->getOptionsStatusSuccessDelete();
				break;
			case 35:
				return $this->getOptionsLineupMaxPlayers();
				break;
			case 36:
				return $this->getOptionsLineupMaxCredits();
				break;
			case 37:
				return $this->getOptionsLineupMaxPlayersTeam();
				break;
			case 38:
				return $this->getOptionsLineupMinG();
				break;
			case 39:
				return $this->getOptionsLineupMinD();
				break;
			case 40:
				return $this->getOptionsLineupMinM();
				break;
			case 41:
				return $this->getOptionsLineupMinS();
				break;
			case 42:
				return $this->getOptionsLineupMaxG();
				break;
			case 43:
				return $this->getOptionsLineupMaxD();
				break;
			case 44:
				return $this->getOptionsLineupMaxM();
				break;
			case 45:
				return $this->getOptionsLineupMaxS();
				break;
			case 46:
				return $this->getOptionsGameRankmode();
				break;
			case 47:
				return $this->getOptionsGamePricemode();
				break;
			case 48:
				return $this->getOptionsGamePointsmode();
				break;
			case 49:
				return $this->getOptionsGameWcpoints();
				break;
			case 50:
				return $this->getOptionsGameRemindHoursBefore();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = FfbOptionsPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getOptionsId(),
			$keys[1] => $this->getOptionsGameId(),
			$keys[2] => $this->getOptionsScoreMinutes(),
			$keys[3] => $this->getOptionsScoreMinutesTreshold(),
			$keys[4] => $this->getOptionsScoreMinutesGt(),
			$keys[5] => $this->getOptionsScoreMinutesLt(),
			$keys[6] => $this->getOptionsScoreMinutesLt30(),
			$keys[7] => $this->getOptionsScoreGoalsG(),
			$keys[8] => $this->getOptionsScoreGoalsD(),
			$keys[9] => $this->getOptionsScoreGoalsM(),
			$keys[10] => $this->getOptionsScoreGoalsS(),
			$keys[11] => $this->getOptionsScoreAssists(),
			$keys[12] => $this->getOptionsScoreNoOppgoalsG(),
			$keys[13] => $this->getOptionsScoreNoOppgoalsD(),
			$keys[14] => $this->getOptionsScoreNoOppgoalsM(),
			$keys[15] => $this->getOptionsScoreOppgoalsG(),
			$keys[16] => $this->getOptionsScoreOppgoalsD(),
			$keys[17] => $this->getOptionsScoreOwngoals(),
			$keys[18] => $this->getOptionsScoreCardY(),
			$keys[19] => $this->getOptionsScoreCardR(),
			$keys[20] => $this->getOptionsScoreCardYr(),
			$keys[21] => $this->getOptionsScorePenaltySaved(),
			$keys[22] => $this->getOptionsScorePenaltyLost(),
			$keys[23] => $this->getOptionsScorePenaltyshootoutSave(),
			$keys[24] => $this->getOptionsScorePenaltyshootoutLost(),
			$keys[25] => $this->getOptionsScorePenaltyshootoutHit(),
			$keys[26] => $this->getOptionsScoreHighLoss(),
			$keys[27] => $this->getOptionsScoreHighWin(),
			$keys[28] => $this->getOptionsScoreHighWinLossTreshold(),
			$keys[29] => $this->getOptionsStatusError(),
			$keys[30] => $this->getOptionsStatusErrorValidation(),
			$keys[31] => $this->getOptionsStatusSuccess(),
			$keys[32] => $this->getOptionsStatusSuccessInsert(),
			$keys[33] => $this->getOptionsStatusSuccessUpdate(),
			$keys[34] => $this->getOptionsStatusSuccessDelete(),
			$keys[35] => $this->getOptionsLineupMaxPlayers(),
			$keys[36] => $this->getOptionsLineupMaxCredits(),
			$keys[37] => $this->getOptionsLineupMaxPlayersTeam(),
			$keys[38] => $this->getOptionsLineupMinG(),
			$keys[39] => $this->getOptionsLineupMinD(),
			$keys[40] => $this->getOptionsLineupMinM(),
			$keys[41] => $this->getOptionsLineupMinS(),
			$keys[42] => $this->getOptionsLineupMaxG(),
			$keys[43] => $this->getOptionsLineupMaxD(),
			$keys[44] => $this->getOptionsLineupMaxM(),
			$keys[45] => $this->getOptionsLineupMaxS(),
			$keys[46] => $this->getOptionsGameRankmode(),
			$keys[47] => $this->getOptionsGamePricemode(),
			$keys[48] => $this->getOptionsGamePointsmode(),
			$keys[49] => $this->getOptionsGameWcpoints(),
			$keys[50] => $this->getOptionsGameRemindHoursBefore(),
		);
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				$this->setOptionsId($value);
				break;
			case 1:
				$this->setOptionsGameId($value);
				break;
			case 2:
				$this->setOptionsScoreMinutes($value);
				break;
			case 3:
				$this->setOptionsScoreMinutesTreshold($value);
				break;
			case 4:
				$this->setOptionsScoreMinutesGt($value);
				break;
			case 5:
				$this->setOptionsScoreMinutesLt($value);
				break;
			case 6:
				$this->setOptionsScoreMinutesLt30($value);
				break;
			case 7:
				$this->setOptionsScoreGoalsG($value);
				break;
			case 8:
				$this->setOptionsScoreGoalsD($value);
				break;
			case 9:
				$this->setOptionsScoreGoalsM($value);
				break;
			case 10:
				$this->setOptionsScoreGoalsS($value);
				break;
			case 11:
				$this->setOptionsScoreAssists($value);
				break;
			case 12:
				$this->setOptionsScoreNoOppgoalsG($value);
				break;
			case 13:
				$this->setOptionsScoreNoOppgoalsD($value);
				break;
			case 14:
				$this->setOptionsScoreNoOppgoalsM($value);
				break;
			case 15:
				$this->setOptionsScoreOppgoalsG($value);
				break;
			case 16:
				$this->setOptionsScoreOppgoalsD($value);
				break;
			case 17:
				$this->setOptionsScoreOwngoals($value);
				break;
			case 18:
				$this->setOptionsScoreCardY($value);
				break;
			case 19:
				$this->setOptionsScoreCardR($value);
				break;
			case 20:
				$this->setOptionsScoreCardYr($value);
				break;
			case 21:
				$this->setOptionsScorePenaltySaved($value);
				break;
			case 22:
				$this->setOptionsScorePenaltyLost($value);
				break;
			case 23:
				$this->setOptionsScorePenaltyshootoutSave($value);
				break;
			case 24:
				$this->setOptionsScorePenaltyshootoutLost($value);
				break;
			case 25:
				$this->setOptionsScorePenaltyshootoutHit($value);
				break;
			case 26:
				$this->setOptionsScoreHighLoss($value);
				break;
			case 27:
				$this->setOptionsScoreHighWin($value);
				break;
			case 28:
				$this->setOptionsScoreHighWinLossTreshold($value);
				break;
			case 29:
				$this->setOptionsStatusError($value);
				break;
			case 30:
				$this->setOptionsStatusErrorValidation($value);
				break;
			case 31:
				$this->setOptionsStatusSuccess($value);
				break;
			case 32:
				$this->setOptionsStatusSuccessInsert($value);
				break;
			case 33:
				$this->setOptionsStatusSuccessUpdate($value);
				break;
			case 34:
				$this->setOptionsStatusSuccessDelete($value);
				break;
			case 35:
				$this->setOptionsLineupMaxPlayers($value);
				break;
			case 36:
				$this->setOptionsLineupMaxCredits($value);
				break;
			case 37:
				$this->setOptionsLineupMaxPlayersTeam($value);
				break;
			case 38:
				$this->setOptionsLineupMinG($value);
				break;
			case 39:
				$this->setOptionsLineupMinD($value);
				break;
			case 40:
				$this->setOptionsLineupMinM($value);
				break;
			case 41:
				$this->setOptionsLineupMinS($value);
				break;
			case 42:
				$this->setOptionsLineupMaxG($value);
				break;
			case 43:
				$this->setOptionsLineupMaxD($value);
				break;
			case 44:
				$this->setOptionsLineupMaxM($value);
				break;
			case 45:
				$this->setOptionsLineupMaxS($value);
				break;
			case 46:
				$this->setOptionsGameRankmode($value);
				break;
			case 47:
				$this->setOptionsGamePricemode($value);
				break;
			case 48:
				$this->setOptionsGamePointsmode($value);
				break;
			case 49:
				$this->setOptionsGameWcpoints($value);
				break;
			case 50:
				$this->setOptionsGameRemindHoursBefore($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setOptionsId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setOptionsGameId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setOptionsScoreMinutes($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setOptionsScoreMinutesTreshold($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setOptionsScoreMinutesGt($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setOptionsScoreMinutesLt($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setOptionsScoreMinutesLt30($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setOptionsScoreGoalsG($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setOptionsScoreGoalsD($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setOptionsScoreGoalsM($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setOptionsScoreGoalsS($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setOptionsScoreAssists($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setOptionsScoreNoOppgoalsG($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setOptionsScoreNoOppgoalsD($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setOptionsScoreNoOppgoalsM($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setOptionsScoreOppgoalsG($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setOptionsScoreOppgoalsD($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setOptionsScoreOwngoals($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setOptionsScoreCardY($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setOptionsScoreCardR($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setOptionsScoreCardYr($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setOptionsScorePenaltySaved($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setOptionsScorePenaltyLost($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setOptionsScorePenaltyshootoutSave($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setOptionsScorePenaltyshootoutLost($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setOptionsScorePenaltyshootoutHit($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setOptionsScoreHighLoss($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setOptionsScoreHighWin($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setOptionsScoreHighWinLossTreshold($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setOptionsStatusError($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setOptionsStatusErrorValidation($arr[$keys[30]]);
		if (array_key_exists($keys[31], $arr)) $this->setOptionsStatusSuccess($arr[$keys[31]]);
		if (array_key_exists($keys[32], $arr)) $this->setOptionsStatusSuccessInsert($arr[$keys[32]]);
		if (array_key_exists($keys[33], $arr)) $this->setOptionsStatusSuccessUpdate($arr[$keys[33]]);
		if (array_key_exists($keys[34], $arr)) $this->setOptionsStatusSuccessDelete($arr[$keys[34]]);
		if (array_key_exists($keys[35], $arr)) $this->setOptionsLineupMaxPlayers($arr[$keys[35]]);
		if (array_key_exists($keys[36], $arr)) $this->setOptionsLineupMaxCredits($arr[$keys[36]]);
		if (array_key_exists($keys[37], $arr)) $this->setOptionsLineupMaxPlayersTeam($arr[$keys[37]]);
		if (array_key_exists($keys[38], $arr)) $this->setOptionsLineupMinG($arr[$keys[38]]);
		if (array_key_exists($keys[39], $arr)) $this->setOptionsLineupMinD($arr[$keys[39]]);
		if (array_key_exists($keys[40], $arr)) $this->setOptionsLineupMinM($arr[$keys[40]]);
		if (array_key_exists($keys[41], $arr)) $this->setOptionsLineupMinS($arr[$keys[41]]);
		if (array_key_exists($keys[42], $arr)) $this->setOptionsLineupMaxG($arr[$keys[42]]);
		if (array_key_exists($keys[43], $arr)) $this->setOptionsLineupMaxD($arr[$keys[43]]);
		if (array_key_exists($keys[44], $arr)) $this->setOptionsLineupMaxM($arr[$keys[44]]);
		if (array_key_exists($keys[45], $arr)) $this->setOptionsLineupMaxS($arr[$keys[45]]);
		if (array_key_exists($keys[46], $arr)) $this->setOptionsGameRankmode($arr[$keys[46]]);
		if (array_key_exists($keys[47], $arr)) $this->setOptionsGamePricemode($arr[$keys[47]]);
		if (array_key_exists($keys[48], $arr)) $this->setOptionsGamePointsmode($arr[$keys[48]]);
		if (array_key_exists($keys[49], $arr)) $this->setOptionsGameWcpoints($arr[$keys[49]]);
		if (array_key_exists($keys[50], $arr)) $this->setOptionsGameRemindHoursBefore($arr[$keys[50]]);
	}
	...
	public function clear()
	{
		...
		$this->options_game_id = null;
		$this->options_score_minutes = null;
		$this->options_score_minutes_treshold = null;
		$this->options_score_minutes_gt = null;
		$this->options_score_minutes_lt = null;
		$this->options_score_minutes_lt30 = null;
		$this->options_score_goals_g = null;
		$this->options_score_goals_d = null;
		$this->options_score_goals_m = null;
		$this->options_score_goals_s = null;
		$this->options_score_assists = null;
		$this->options_score_no_oppgoals_g = null;
		$this->options_score_no_oppgoals_d = null;
		$this->options_score_no_oppgoals_m = null;
		$this->options_score_oppgoals_g = null;
		$this->options_score_oppgoals_d = null;
		$this->options_score_owngoals = null;
		$this->options_score_card_y = null;
		$this->options_score_card_r = null;
		$this->options_score_card_yr = null;
		$this->options_score_penalty_saved = null;
		$this->options_score_penalty_lost = null;
		$this->options_score_penaltyshootout_save = null;
		$this->options_score_penaltyshootout_lost = null;
		$this->options_score_penaltyshootout_hit = null;
		$this->options_score_high_loss = null;
		$this->options_score_high_win = null;
		$this->options_score_high_win_loss_treshold = null;
		$this->options_status_error = null;
		$this->options_status_error_validation = null;
		$this->options_status_success = null;
		$this->options_status_success_insert = null;
		$this->options_status_success_update = null;
		$this->options_status_success_delete = null;
		$this->options_lineup_max_players = null;
		$this->options_lineup_max_credits = null;
		$this->options_lineup_max_players_team = null;
		$this->options_lineup_min_g = null;
		$this->options_lineup_min_d = null;
		$this->options_lineup_min_m = null;
		$this->options_lineup_min_s = null;
		$this->options_lineup_max_g = null;
		$this->options_lineup_max_d = null;
		$this->options_lineup_max_m = null;
		$this->options_lineup_max_s = null;
		$this->options_game_rankmode = null;
		$this->options_game_pricemode = null;
		$this->options_game_pointsmode = null;
		$this->options_game_wcpoints = null;
		$this->options_game_remind_hours_before = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
