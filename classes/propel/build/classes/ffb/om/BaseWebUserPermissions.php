...
abstract class BaseWebUserPermissions extends BaseObject  implements Persistent
{
	 ...
	 * Peer class name
	 */
	const PEER = 'WebUserPermissionsPeer';
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				WebUserPermissionsQuery::create()
	...
	{
		$pos = WebUserPermissionsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getUserPermissionsFfbMailserviceReminder();
				break;
			case 2:
	...
	{
		$keys = WebUserPermissionsPeer::getFieldNames($keyType);
		$result = array(
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				$this->setUserPermissionsFfbMailserviceReminder($value);
				break;
			case 2:
