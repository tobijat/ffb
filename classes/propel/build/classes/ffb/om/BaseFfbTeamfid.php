...
abstract class BaseFfbTeamfid extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->teamfid_id = (($row[$startcol + 0] ?? null) !== null) ? (int) $row[$startcol + 0] : null;
			$this->teamfid_team_id = (($row[$startcol + 1] ?? null) !== null) ? (int) $row[$startcol + 1] : null;
			$this->teamfid_fid_foe = (($row[$startcol + 2] ?? null) !== null) ? (string) $row[$startcol + 2] : null;
			$this->teamfid_fid_tm = (($row[$startcol + 3] ?? null) !== null) ? (string) $row[$startcol + 3] : null;
			$this->teamfid_fid_wf = (($row[$startcol + 4] ?? null) !== null) ? (string) $row[$startcol + 4] : null;
			$this->teamfid_name_foe = (($row[$startcol + 5] ?? null) !== null) ? (string) $row[$startcol + 5] : null;
			$this->teamfid_name_tm = (($row[$startcol + 6] ?? null) !== null) ? (string) $row[$startcol + 6] : null;
			$this->teamfid_name_wf = (($row[$startcol + 7] ?? null) !== null) ? (string) $row[$startcol + 7] : null;
			$this->teamfid_url_foe = (($row[$startcol + 8] ?? null) !== null) ? (string) $row[$startcol + 8] : null;
			$this->teamfid_url_tm = (($row[$startcol + 9] ?? null) !== null) ? (string) $row[$startcol + 9] : null;
			$this->teamfid_url_wf = (($row[$startcol + 10] ?? null) !== null) ? (string) $row[$startcol + 10] : null;
			$this->resetModified();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(FfbTeamfidPeer::TEAMFID_ID) ) {
	...
	{
		$pos = FfbTeamfidPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getTeamfidTeamId();
				break;
			case 2:
				return $this->getTeamfidFidFoe();
				break;
			case 3:
				return $this->getTeamfidFidTm();
				break;
			case 4:
				return $this->getTeamfidFidWf();
				break;
			case 5:
				return $this->getTeamfidNameFoe();
				break;
			case 6:
				return $this->getTeamfidNameTm();
				break;
			case 7:
				return $this->getTeamfidNameWf();
				break;
			case 8:
				return $this->getTeamfidUrlFoe();
				break;
			case 9:
				return $this->getTeamfidUrlTm();
				break;
			case 10:
				return $this->getTeamfidUrlWf();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = FfbTeamfidPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getTeamfidId(),
			$keys[1] => $this->getTeamfidTeamId(),
			$keys[2] => $this->getTeamfidFidFoe(),
			$keys[3] => $this->getTeamfidFidTm(),
			$keys[4] => $this->getTeamfidFidWf(),
			$keys[5] => $this->getTeamfidNameFoe(),
			$keys[6] => $this->getTeamfidNameTm(),
			$keys[7] => $this->getTeamfidNameWf(),
			$keys[8] => $this->getTeamfidUrlFoe(),
			$keys[9] => $this->getTeamfidUrlTm(),
			$keys[10] => $this->getTeamfidUrlWf(),
		);
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				$this->setTeamfidId($value);
				break;
			case 1:
				$this->setTeamfidTeamId($value);
				break;
			case 2:
				$this->setTeamfidFidFoe($value);
				break;
			case 3:
				$this->setTeamfidFidTm($value);
				break;
			case 4:
				$this->setTeamfidFidWf($value);
				break;
			case 5:
				$this->setTeamfidNameFoe($value);
				break;
			case 6:
				$this->setTeamfidNameTm($value);
				break;
			case 7:
				$this->setTeamfidNameWf($value);
				break;
			case 8:
				$this->setTeamfidUrlFoe($value);
				break;
			case 9:
				$this->setTeamfidUrlTm($value);
				break;
			case 10:
				$this->setTeamfidUrlWf($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setTeamfidId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setTeamfidTeamId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setTeamfidFidFoe($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setTeamfidFidTm($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setTeamfidFidWf($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setTeamfidNameFoe($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setTeamfidNameTm($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setTeamfidNameWf($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setTeamfidUrlFoe($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setTeamfidUrlTm($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setTeamfidUrlWf($arr[$keys[10]]);
	}
	...
	public function getFfbTeam(?PropelPDO $con = null)
	{
		if ($this->aFfbTeam === null && ($this->teamfid_team_id !== null)) {
			$this->aFfbTeam = FfbTeamQuery::create()->findPk($this->teamfid_team_id, $con);
	...
	{
		$this->teamfid_id = null;
		$this->teamfid_team_id = null;
		$this->teamfid_fid_foe = null;
		$this->teamfid_fid_tm = null;
		$this->teamfid_fid_wf = null;
		$this->teamfid_name_foe = null;
		$this->teamfid_name_tm = null;
		$this->teamfid_name_wf = null;
		$this->teamfid_url_foe = null;
		$this->teamfid_url_tm = null;
		$this->teamfid_url_wf = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
