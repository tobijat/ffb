...
abstract class BaseFfbPlayerstats extends BaseObject  implements Persistent
{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(FfbPlayerstatsPeer::PLAYERSTATS_ID) ) {
	...
	{
		$pos = FfbPlayerstatsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getPlayerstatsPlayerteamId();
				break;
			case 2:
				return $this->getPlayerstatsMatchId();
				break;
			case 3:
				return $this->getPlayerstatsMatchroundId();
				break;
			case 4:
				return $this->getPlayerstatsGoals();
				break;
			case 5:
				return $this->getPlayerstatsAssists();
				break;
			case 6:
				return $this->getPlayerstatsMinutes();
				break;
			case 7:
				return $this->getPlayerstatsMinuteIn();
				break;
			case 8:
				return $this->getPlayerstatsMinuteOut();
				break;
			case 9:
				return $this->getPlayerstatsCards();
				break;
			case 10:
				return $this->getPlayerstatsOwngoals();
				break;
			case 11:
				return $this->getPlayerstatsPenaltieslost();
				break;
			case 12:
				return $this->getPlayerstatsPenaltiessaved();
				break;
			case 13:
				return $this->getPlayerstatsPenaltyshootoutSave();
				break;
			case 14:
				return $this->getPlayerstatsPenaltyshootoutLost();
				break;
			case 15:
				return $this->getPlayerstatsPenaltyshootoutHit();
				break;
			case 16:
				return $this->getPlayerstatsScoreGoals();
				break;
			case 17:
				return $this->getPlayerstatsScoreAssists();
				break;
			case 18:
				return $this->getPlayerstatsScoreMinutes();
				break;
			case 19:
				return $this->getPlayerstatsScoreCards();
				break;
			case 20:
				return $this->getPlayerstatsScoreOwngoals();
				break;
			case 21:
				return $this->getPlayerstatsScorePenaltieslost();
				break;
			case 22:
				return $this->getPlayerstatsScorePenaltiessaved();
				break;
			case 23:
				return $this->getPlayerstatsScoreOppgoals();
				break;
			case 24:
				return $this->getPlayerstatsScoreNooppgoals();
				break;
			case 25:
				return $this->getPlayerstatsScoreHighLoss();
				break;
			case 26:
				return $this->getPlayerstatsScoreHighWin();
				break;
			case 27:
				return $this->getPlayerstatsScorePenaltyshootoutSave();
				break;
			case 28:
				return $this->getPlayerstatsScorePenaltyshootoutLost();
				break;
			case 29:
				return $this->getPlayerstatsScorePenaltyshootoutHit();
				break;
			case 30:
				return $this->getPlayerstatsScore();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = FfbPlayerstatsPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getPlayerstatsId(),
			$keys[1] => $this->getPlayerstatsPlayerteamId(),
			$keys[2] => $this->getPlayerstatsMatchId(),
			$keys[3] => $this->getPlayerstatsMatchroundId(),
			$keys[4] => $this->getPlayerstatsGoals(),
			$keys[5] => $this->getPlayerstatsAssists(),
			$keys[6] => $this->getPlayerstatsMinutes(),
			$keys[7] => $this->getPlayerstatsMinuteIn(),
			$keys[8] => $this->getPlayerstatsMinuteOut(),
			$keys[9] => $this->getPlayerstatsCards(),
			$keys[10] => $this->getPlayerstatsOwngoals(),
			$keys[11] => $this->getPlayerstatsPenaltieslost(),
			$keys[12] => $this->getPlayerstatsPenaltiessaved(),
			$keys[13] => $this->getPlayerstatsPenaltyshootoutSave(),
			$keys[14] => $this->getPlayerstatsPenaltyshootoutLost(),
			$keys[15] => $this->getPlayerstatsPenaltyshootoutHit(),
			$keys[16] => $this->getPlayerstatsScoreGoals(),
			$keys[17] => $this->getPlayerstatsScoreAssists(),
			$keys[18] => $this->getPlayerstatsScoreMinutes(),
			$keys[19] => $this->getPlayerstatsScoreCards(),
			$keys[20] => $this->getPlayerstatsScoreOwngoals(),
			$keys[21] => $this->getPlayerstatsScorePenaltieslost(),
			$keys[22] => $this->getPlayerstatsScorePenaltiessaved(),
			$keys[23] => $this->getPlayerstatsScoreOppgoals(),
			$keys[24] => $this->getPlayerstatsScoreNooppgoals(),
			$keys[25] => $this->getPlayerstatsScoreHighLoss(),
			$keys[26] => $this->getPlayerstatsScoreHighWin(),
			$keys[27] => $this->getPlayerstatsScorePenaltyshootoutSave(),
			$keys[28] => $this->getPlayerstatsScorePenaltyshootoutLost(),
			$keys[29] => $this->getPlayerstatsScorePenaltyshootoutHit(),
			$keys[30] => $this->getPlayerstatsScore(),
		);
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				$this->setPlayerstatsId($value);
				break;
			case 1:
				$this->setPlayerstatsPlayerteamId($value);
				break;
			case 2:
				$this->setPlayerstatsMatchId($value);
				break;
			case 3:
				$this->setPlayerstatsMatchroundId($value);
				break;
			case 4:
				$this->setPlayerstatsGoals($value);
				break;
			case 5:
				$this->setPlayerstatsAssists($value);
				break;
			case 6:
				$this->setPlayerstatsMinutes($value);
				break;
			case 7:
				$this->setPlayerstatsMinuteIn($value);
				break;
			case 8:
				$this->setPlayerstatsMinuteOut($value);
				break;
			case 9:
				$this->setPlayerstatsCards($value);
				break;
			case 10:
				$this->setPlayerstatsOwngoals($value);
				break;
			case 11:
				$this->setPlayerstatsPenaltieslost($value);
				break;
			case 12:
				$this->setPlayerstatsPenaltiessaved($value);
				break;
			case 13:
				$this->setPlayerstatsPenaltyshootoutSave($value);
				break;
			case 14:
				$this->setPlayerstatsPenaltyshootoutLost($value);
				break;
			case 15:
				$this->setPlayerstatsPenaltyshootoutHit($value);
				break;
			case 16:
				$this->setPlayerstatsScoreGoals($value);
				break;
			case 17:
				$this->setPlayerstatsScoreAssists($value);
				break;
			case 18:
				$this->setPlayerstatsScoreMinutes($value);
				break;
			case 19:
				$this->setPlayerstatsScoreCards($value);
				break;
			case 20:
				$this->setPlayerstatsScoreOwngoals($value);
				break;
			case 21:
				$this->setPlayerstatsScorePenaltieslost($value);
				break;
			case 22:
				$this->setPlayerstatsScorePenaltiessaved($value);
				break;
			case 23:
				$this->setPlayerstatsScoreOppgoals($value);
				break;
			case 24:
				$this->setPlayerstatsScoreNooppgoals($value);
				break;
			case 25:
				$this->setPlayerstatsScoreHighLoss($value);
				break;
			case 26:
				$this->setPlayerstatsScoreHighWin($value);
				break;
			case 27:
				$this->setPlayerstatsScorePenaltyshootoutSave($value);
				break;
			case 28:
				$this->setPlayerstatsScorePenaltyshootoutLost($value);
				break;
			case 29:
				$this->setPlayerstatsScorePenaltyshootoutHit($value);
				break;
			case 30:
				$this->setPlayerstatsScore($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setPlayerstatsId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setPlayerstatsPlayerteamId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setPlayerstatsMatchId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setPlayerstatsMatchroundId($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setPlayerstatsGoals($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setPlayerstatsAssists($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setPlayerstatsMinutes($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setPlayerstatsMinuteIn($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setPlayerstatsMinuteOut($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setPlayerstatsCards($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setPlayerstatsOwngoals($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setPlayerstatsPenaltieslost($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setPlayerstatsPenaltiessaved($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setPlayerstatsPenaltyshootoutSave($arr[$keys[13]]);
		if (array_key_exists($keys[14], $arr)) $this->setPlayerstatsPenaltyshootoutLost($arr[$keys[14]]);
		if (array_key_exists($keys[15], $arr)) $this->setPlayerstatsPenaltyshootoutHit($arr[$keys[15]]);
		if (array_key_exists($keys[16], $arr)) $this->setPlayerstatsScoreGoals($arr[$keys[16]]);
		if (array_key_exists($keys[17], $arr)) $this->setPlayerstatsScoreAssists($arr[$keys[17]]);
		if (array_key_exists($keys[18], $arr)) $this->setPlayerstatsScoreMinutes($arr[$keys[18]]);
		if (array_key_exists($keys[19], $arr)) $this->setPlayerstatsScoreCards($arr[$keys[19]]);
		if (array_key_exists($keys[20], $arr)) $this->setPlayerstatsScoreOwngoals($arr[$keys[20]]);
		if (array_key_exists($keys[21], $arr)) $this->setPlayerstatsScorePenaltieslost($arr[$keys[21]]);
		if (array_key_exists($keys[22], $arr)) $this->setPlayerstatsScorePenaltiessaved($arr[$keys[22]]);
		if (array_key_exists($keys[23], $arr)) $this->setPlayerstatsScoreOppgoals($arr[$keys[23]]);
		if (array_key_exists($keys[24], $arr)) $this->setPlayerstatsScoreNooppgoals($arr[$keys[24]]);
		if (array_key_exists($keys[25], $arr)) $this->setPlayerstatsScoreHighLoss($arr[$keys[25]]);
		if (array_key_exists($keys[26], $arr)) $this->setPlayerstatsScoreHighWin($arr[$keys[26]]);
		if (array_key_exists($keys[27], $arr)) $this->setPlayerstatsScorePenaltyshootoutSave($arr[$keys[27]]);
		if (array_key_exists($keys[28], $arr)) $this->setPlayerstatsScorePenaltyshootoutLost($arr[$keys[28]]);
		if (array_key_exists($keys[29], $arr)) $this->setPlayerstatsScorePenaltyshootoutHit($arr[$keys[29]]);
		if (array_key_exists($keys[30], $arr)) $this->setPlayerstatsScore($arr[$keys[30]]);
	}
	...
	{
		return null === $this->getPlayerstatsId();
	}
	...
	{
		$this->playerstats_id = null;
		$this->playerstats_playerteam_id = null;
		$this->playerstats_match_id = null;
		$this->playerstats_matchround_id = null;
		$this->playerstats_goals = null;
		$this->playerstats_assists = null;
		$this->playerstats_minutes = null;
		$this->playerstats_minute_in = null;
		$this->playerstats_minute_out = null;
		$this->playerstats_cards = null;
		$this->playerstats_owngoals = null;
		$this->playerstats_penaltieslost = null;
		$this->playerstats_penaltiessaved = null;
		$this->playerstats_penaltyshootout_save = null;
		$this->playerstats_penaltyshootout_lost = null;
		$this->playerstats_penaltyshootout_hit = null;
		$this->playerstats_score_goals = null;
		$this->playerstats_score_assists = null;
		$this->playerstats_score_minutes = null;
		$this->playerstats_score_cards = null;
		$this->playerstats_score_owngoals = null;
		$this->playerstats_score_penaltieslost = null;
		$this->playerstats_score_penaltiessaved = null;
		$this->playerstats_score_oppgoals = null;
		$this->playerstats_score_nooppgoals = null;
		$this->playerstats_score_high_loss = null;
		$this->playerstats_score_high_win = null;
		$this->playerstats_score_penaltyshootout_save = null;
		$this->playerstats_score_penaltyshootout_lost = null;
		$this->playerstats_score_penaltyshootout_hit = null;
		$this->playerstats_score = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
