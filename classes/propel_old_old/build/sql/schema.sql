...
(
	...
	`user_permissions_ffb_facebook` VARCHAR(255)  NOT NULL,
	`user_permissions_pictory_facebook` VARCHAR(255)  NOT NULL,
	`user_permissions_facebook_connected` TINYINT default 0 NOT NULL,
...
(
	...
	`user_award_defines_facebook_description` VARCHAR(255)  NOT NULL,
...
(
	...
	`user_award_finished_facebook_stream_id` VARCHAR(255)  NOT NULL,
