...
abstract class BaseFfbMatch extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->match_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			$this->match_round = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->match_hometeam_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->match_guestteam_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->match_homescore = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->match_guestscore = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->match_homescore_penalty = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->match_guestscore_penalty = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->match_date = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->match_minutes = ($row[$startcol + 9] !== null) ? (int) $row[$startcol + 9] : null;
			$this->match_status = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->match_url = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
			$this->resetModified();
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				FfbMatchPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = FfbMatchPeer::doInsert($this, $con);
	...
	public function getFfbMatchround(PropelPDO $con = null)
	{
		if ($this->aFfbMatchround === null && ($this->match_round !== null)) {
			$this->aFfbMatchround = FfbMatchroundPeer::retrieveByPk($this->match_round);
	...
	public function getFfbTeamRelatedByMatchHometeamId(PropelPDO $con = null)
	{
		if ($this->aFfbTeamRelatedByMatchHometeamId === null && ($this->match_hometeam_id !== null)) {
			$this->aFfbTeamRelatedByMatchHometeamId = FfbTeamPeer::retrieveByPk($this->match_hometeam_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	public function getFfbTeamRelatedByMatchGuestteamId(PropelPDO $con = null)
	{
		if ($this->aFfbTeamRelatedByMatchGuestteamId === null && ($this->match_guestteam_id !== null)) {
			$this->aFfbTeamRelatedByMatchGuestteamId = FfbTeamPeer::retrieveByPk($this->match_guestteam_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	 ...
	 * Otherwise if this FfbMatch has previously been saved, it will retrieve
	 * related FfbGoals from storage. If this FfbMatch is new, it will return
		...
		if ($this->collFfbGoals === null) {
			if ($this->isNew()) {
			   $this->collFfbGoals = array();
				...
				$criteria->add(FfbGoalPeer::GOAL_MATCH_ID, $this->match_id);
	...
	public function getFfbGoalsJoinFfbPlayerteam($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collFfbGoals === null) {
			if ($this->isNew()) {
				...
				$this->collFfbGoals = FfbGoalPeer::doSelectJoinFfbPlayerteam($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this FfbMatch has previously been saved, it will retrieve
	 * related FfbPsgoals from storage. If this FfbMatch is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFfbPsgoals === null) {
			if ($this->isNew()) {
			   $this->collFfbPsgoals = array();
				...
				$criteria->add(FfbPsgoalPeer::PSGOAL_MATCH_ID, $this->match_id);
	...
	public function getFfbPsgoalsJoinFfbPlayerteam($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collFfbPsgoals === null) {
			if ($this->isNew()) {
				...
				$this->collFfbPsgoals = FfbPsgoalPeer::doSelectJoinFfbPlayerteam($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this FfbMatch has previously been saved, it will retrieve
	 * related FfbPlayerstatss from storage. If this FfbMatch is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFfbPlayerstatss === null) {
			if ($this->isNew()) {
			   $this->collFfbPlayerstatss = array();
				...
				$criteria->add(FfbPlayerstatsPeer::PLAYERSTATS_MATCH_ID, $this->match_id);
