...
abstract class BaseFfbGamePeer {
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in FfbMatchroundPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
		FfbMatchroundPeer::clearInstancePool();

		// invalidate objects in FfbNewsPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(FfbGamePeer::GAME_ID, $criteria->remove(FfbGamePeer::GAME_ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(FfbGamePeer::TABLE_NAME, $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof FfbGame) {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += FfbGamePeer::doOnDeleteCascade($criteria, $con);
