...
abstract class BaseFfbUserAwardFinishedPeer {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(FfbUserAwardFinishedPeer::USER_AWARD_FINISHED_ID, $criteria->remove(FfbUserAwardFinishedPeer::USER_AWARD_FINISHED_ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(FfbUserAwardFinishedPeer::TABLE_NAME, $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof FfbUserAwardFinished) {
