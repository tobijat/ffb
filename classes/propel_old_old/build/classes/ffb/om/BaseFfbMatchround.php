...
abstract class BaseFfbMatchround extends BaseObject  implements Persistent {
	...
	/**
	 * @var        Criteria The criteria used to select the current contents of collFfbMatchs.
	 */
	private $lastFfbMatchCriteria = null;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->lastFfbMatchCriteria = null;
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			if ($ret) {
				FfbMatchroundPeer::doDelete($this, $con);
				$this->postDelete($con);
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = FfbMatchroundPeer::doInsert($this, $con);
	...
	public function getFfbGame(PropelPDO $con = null)
	{
		if ($this->aFfbGame === null && ($this->matchround_game_id !== null)) {
			$this->aFfbGame = FfbGamePeer::retrieveByPk($this->matchround_game_id);
	 ...
	 * Otherwise if this FfbMatchround has previously been saved, it will retrieve
	 * related FfbCommentss from storage. If this FfbMatchround is new, it will return
		...
		if ($this->collFfbCommentss === null) {
			if ($this->isNew()) {
			   $this->collFfbCommentss = array();
				...
				$criteria->add(FfbCommentsPeer::COMMENTS_MATCHROUND_ID, $this->matchround_id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this FfbMatchround has previously been saved, it will retrieve
	 * related FfbPlayerprices from storage. If this FfbMatchround is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFfbPlayerprices === null) {
			if ($this->isNew()) {
			   $this->collFfbPlayerprices = array();
				...
				$criteria->add(FfbPlayerpricePeer::PLAYERPRICE_MATCHROUND_ID, $this->matchround_id);
	...
	public function getFfbPlayerpricesJoinFfbPlayerteam($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collFfbPlayerprices === null) {
			if ($this->isNew()) {
				...
				$this->collFfbPlayerprices = FfbPlayerpricePeer::doSelectJoinFfbPlayerteam($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collFfbMatchs collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	...
	/**
	 * Initializes the collFfbMatchs collection (array).
	 *
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this FfbMatchround has previously been saved, it will retrieve
	 * related FfbMatchs from storage. If this FfbMatchround is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFfbMatchs === null) {
			if ($this->isNew()) {
			   $this->collFfbMatchs = array();
				...
				$criteria->add(FfbMatchPeer::MATCH_ROUND, $this->matchround_id);

				FfbMatchPeer::addSelectColumns($criteria);
				$this->collFfbMatchs = FfbMatchPeer::doSelect($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				FfbMatchPeer::addSelectColumns($criteria);
				if (!isset($this->lastFfbMatchCriteria) || !$this->lastFfbMatchCriteria->equals($criteria)) {
					$this->collFfbMatchs = FfbMatchPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastFfbMatchCriteria = $criteria;
		...
		if ($this->collFfbMatchs === null) {
			...
			if (!$this->isNew()) {
				...
				if (!isset($this->lastFfbMatchCriteria) || !$this->lastFfbMatchCriteria->equals($criteria)) {
					...
					$count = count($this->collFfbMatchs);
				}
			} else {
				$count = count($this->collFfbMatchs);
			}
	...
	public function addFfbMatch(FfbMatch $l)
	{
		...
		if (!in_array($l, $this->collFfbMatchs, true)) { // only add it if the **same** object is not already associated
			array_push($this->collFfbMatchs, $l);
			$l->setFfbMatchround($this);
		}
	}
	...
	public function getFfbMatchsJoinFfbTeamRelatedByMatchHometeamId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collFfbMatchs === null) {
			if ($this->isNew()) {
				...
				$this->collFfbMatchs = FfbMatchPeer::doSelectJoinFfbTeamRelatedByMatchHometeamId($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	public function getFfbMatchsJoinFfbTeamRelatedByMatchGuestteamId($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collFfbMatchs === null) {
			if ($this->isNew()) {
				...
				$this->collFfbMatchs = FfbMatchPeer::doSelectJoinFfbTeamRelatedByMatchGuestteamId($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this FfbMatchround has previously been saved, it will retrieve
	 * related FfbPlayerstatss from storage. If this FfbMatchround is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFfbPlayerstatss === null) {
			if ($this->isNew()) {
			   $this->collFfbPlayerstatss = array();
				...
				$criteria->add(FfbPlayerstatsPeer::PLAYERSTATS_MATCHROUND_ID, $this->matchround_id);
	...
	public function getFfbPlayerstatssJoinFfbPlayerteam($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collFfbPlayerstatss === null) {
			if ($this->isNew()) {
				...
				$this->collFfbPlayerstatss = FfbPlayerstatsPeer::doSelectJoinFfbPlayerteam($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this FfbMatchround has previously been saved, it will retrieve
	 * related FfbUserteams from storage. If this FfbMatchround is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collFfbUserteams === null) {
			if ($this->isNew()) {
			   $this->collFfbUserteams = array();
				...
				$criteria->add(FfbUserteamPeer::USERTEAM_MATCHROUND_ID, $this->matchround_id);
	...
	public function getFfbUserteamsJoinWebUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		if ($this->collFfbUserteams === null) {
			if ($this->isNew()) {
				...
				$this->collFfbUserteams = FfbUserteamPeer::doSelectJoinWebUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
