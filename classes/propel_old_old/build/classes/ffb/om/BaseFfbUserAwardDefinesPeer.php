...
abstract class BaseFfbUserAwardDefinesPeer {
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(FfbUserAwardDefinesPeer::USER_AWARD_DEFINES_ID, $criteria->remove(FfbUserAwardDefinesPeer::USER_AWARD_DEFINES_ID), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(FfbUserAwardDefinesPeer::TABLE_NAME, $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof FfbUserAwardDefines) {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += FfbUserAwardDefinesPeer::doOnDeleteCascade($criteria, $con);
