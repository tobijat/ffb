...
abstract class BaseFfbPlayerfid extends BaseObject  implements Persistent
{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(FfbPlayerfidPeer::PLAYERFID_ID) ) {
	...
	{
		$pos = FfbPlayerfidPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			case 0:
				...
				break;
			case 1:
				return $this->getPlayerfidPlayerteamId();
				break;
			case 2:
				return $this->getPlayerfidTeamId();
				break;
			case 3:
				return $this->getPlayerfidFidFoe();
				break;
			case 4:
				return $this->getPlayerfidFidFifa();
				break;
			case 5:
				return $this->getPlayerfidFidTm();
				break;
			case 6:
				return $this->getPlayerfidFidUefa();
				break;
			case 7:
				return $this->getPlayerfidFidWf();
				break;
			case 8:
				return $this->getPlayerfidNameFoe();
				break;
			case 9:
				return $this->getPlayerfidNameFifa();
				break;
			case 10:
				return $this->getPlayerfidNameTm();
				break;
			case 11:
				return $this->getPlayerfidNameUefa();
				break;
			case 12:
				return $this->getPlayerfidNameWf();
				break;
			default:
				return null;
				break;
	...
	{
		$keys = FfbPlayerfidPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getPlayerfidId(),
			$keys[1] => $this->getPlayerfidPlayerteamId(),
			$keys[2] => $this->getPlayerfidTeamId(),
			$keys[3] => $this->getPlayerfidFidFoe(),
			$keys[4] => $this->getPlayerfidFidFifa(),
			$keys[5] => $this->getPlayerfidFidTm(),
			$keys[6] => $this->getPlayerfidFidUefa(),
			$keys[7] => $this->getPlayerfidFidWf(),
			$keys[8] => $this->getPlayerfidNameFoe(),
			$keys[9] => $this->getPlayerfidNameFifa(),
			$keys[10] => $this->getPlayerfidNameTm(),
			$keys[11] => $this->getPlayerfidNameUefa(),
			$keys[12] => $this->getPlayerfidNameWf(),
		);
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			case 0:
				$this->setPlayerfidId($value);
				break;
			case 1:
				$this->setPlayerfidPlayerteamId($value);
				break;
			case 2:
				$this->setPlayerfidTeamId($value);
				break;
			case 3:
				$this->setPlayerfidFidFoe($value);
				break;
			case 4:
				$this->setPlayerfidFidFifa($value);
				break;
			case 5:
				$this->setPlayerfidFidTm($value);
				break;
			case 6:
				$this->setPlayerfidFidUefa($value);
				break;
			case 7:
				$this->setPlayerfidFidWf($value);
				break;
			case 8:
				$this->setPlayerfidNameFoe($value);
				break;
			case 9:
				$this->setPlayerfidNameFifa($value);
				break;
			case 10:
				$this->setPlayerfidNameTm($value);
				break;
			case 11:
				$this->setPlayerfidNameUefa($value);
				break;
			case 12:
				$this->setPlayerfidNameWf($value);
				break;
		} // switch()
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setPlayerfidId($arr[$keys[0]]);
		if (array_key_exists($keys[1], $arr)) $this->setPlayerfidPlayerteamId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setPlayerfidTeamId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setPlayerfidFidFoe($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setPlayerfidFidFifa($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setPlayerfidFidTm($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setPlayerfidFidUefa($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setPlayerfidFidWf($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setPlayerfidNameFoe($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setPlayerfidNameFifa($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setPlayerfidNameTm($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setPlayerfidNameUefa($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setPlayerfidNameWf($arr[$keys[12]]);
	}
	...
	{
		return null === $this->getPlayerfidId();
	}
	...
	{
		$this->playerfid_id = null;
		$this->playerfid_playerteam_id = null;
		$this->playerfid_team_id = null;
		$this->playerfid_fid_foe = null;
		$this->playerfid_fid_fifa = null;
		$this->playerfid_fid_tm = null;
		$this->playerfid_fid_uefa = null;
		$this->playerfid_fid_wf = null;
		$this->playerfid_name_foe = null;
		$this->playerfid_name_fifa = null;
		$this->playerfid_name_tm = null;
		$this->playerfid_name_uefa = null;
		$this->playerfid_name_wf = null;
		$this->alreadyInSave = false;
		$this->alreadyInValidation = false;
