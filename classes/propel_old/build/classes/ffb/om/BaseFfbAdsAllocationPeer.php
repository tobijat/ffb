...
abstract class BaseFfbAdsAllocationPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ADS_ALLOCATION_ID', 'ADS_ALLOCATION_ADS_ID', 'ADS_ALLOCATION_SLOT_ID', 'ADS_ALLOCATION_GAME_ID', 'ADS_ALLOCATION_AD_COUNT', 'ADS_ALLOCATION_AD_MAX', 'ADS_ALLOCATION_AD_PRIORITY', 'ADS_ALLOCATION_START', 'ADS_ALLOCATION_END', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_RAW_COLNAME => array ('ADS_ALLOCATION_ID' => 0, 'ADS_ALLOCATION_ADS_ID' => 1, 'ADS_ALLOCATION_SLOT_ID' => 2, 'ADS_ALLOCATION_GAME_ID' => 3, 'ADS_ALLOCATION_AD_COUNT' => 4, 'ADS_ALLOCATION_AD_MAX' => 5, 'ADS_ALLOCATION_AD_PRIORITY' => 6, 'ADS_ALLOCATION_START' => 7, 'ADS_ALLOCATION_END' => 8, ),
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn($alias . '.ADS_ALLOCATION_ID');
			$criteria->addSelectColumn($alias . '.ADS_ALLOCATION_ADS_ID');
			$criteria->addSelectColumn($alias . '.ADS_ALLOCATION_SLOT_ID');
			$criteria->addSelectColumn($alias . '.ADS_ALLOCATION_GAME_ID');
			$criteria->addSelectColumn($alias . '.ADS_ALLOCATION_AD_COUNT');
			$criteria->addSelectColumn($alias . '.ADS_ALLOCATION_AD_MAX');
			$criteria->addSelectColumn($alias . '.ADS_ALLOCATION_AD_PRIORITY');
			$criteria->addSelectColumn($alias . '.ADS_ALLOCATION_START');
			$criteria->addSelectColumn($alias . '.ADS_ALLOCATION_END');
		}
	}
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (FfbAdsAllocation object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = FfbAdsAllocationPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = FfbAdsAllocationPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + FfbAdsAllocationPeer::NUM_COLUMNS;
		} else {
			$cls = FfbAdsAllocationPeer::OM_CLASS;
			$obj = new $cls();
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(FfbAdsAllocationPeer::ADS_ALLOCATION_ID);
			if ($value) {
				$selectCriteria->add(FfbAdsAllocationPeer::ADS_ALLOCATION_ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(FfbAdsAllocationPeer::TABLE_NAME);
			}
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(FfbAdsAllocationPeer::TABLE_NAME, $con, FfbAdsAllocationPeer::DATABASE_NAME);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof FfbAdsAllocation) { // it's a model object
