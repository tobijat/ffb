<head>
	...
	<title><?= strtoupper($this->module->moduleName).' - '.strtoupper($this->module->name)?> - Welcome to the world of Fantasy Football!</title>
</head>
<body onload="init();">
<div id="Container">
    ...
    <div id="Main">
        ...
        <div id="administration">
            ...
            <applet archive="<?= PIC_BASE_PATH.PIC_SCRIPT_PATH;?>jupload-V3.4.1f-src.jar" width="320" height="240">
            </applet>
        </div>
    </div>
</div>
