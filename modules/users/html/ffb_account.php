		...
		<div id="reg_left_main">
			...
			<div id="reg_form">
				<form name="registration" action="./account" method="post">
				    ...
				    <div id="reg_formline">
				        <div id="reg_formdescr">Passwort &auml;ndern:</div>
				        <div id="reg_forminput">
				            <input type="password" class="input" name="user_password_chg" size="50" onMouseOver="javascript:dispRegHelp(this.name);" onFocus="javascript:dispRegHelp(this.name);">
				        </div>
				        <div id="reg_formclear"></div>
				    </div>

				    <div id="reg_formline">
				        <div id="reg_formdescr">Passwort&auml;nderung wiederholen:</div>
				        <div id="reg_forminput">
				            <input type="password" class="input" name="user_password_val_chg" size="50" onMouseOver="javascript:dispRegHelp(this.name);" onFocus="javascript:dispRegHelp(this.name);">
				        </div>
				        <div id="reg_formclear"></div>
				    </div>
				    ...
				    <div id="reg_formline">
				        ...
				        <div id="reg_forminput">
			                <input type="submit" class="submit" value="&Auml;nderungen abschicken" name="users_registration_update">
				        </div>
				    </div>
				    <div id="reg_formclear"></div>
				</form>
