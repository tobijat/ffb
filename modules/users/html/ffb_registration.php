    ...
    <link rel="stylesheet" href="<?echo FFB_BASE_PATH.FFB_INCLUDE_PATH?>registration.css" type="text/css">
	...
	<script type="text/javascript" src="<?echo FFB_BASE_PATH.SCRIPT_PATH?>user/registration.js"></script>
</head>
<body>
				...
				<form name="registration" action="./registration" method="post">
					<div id="reg_formline">
				        ...
				        <div id="reg_forminput">
				            <input type="text" class="input" name="user_nickname" size="50" value="<?echo $this->post['user_nickname'];?>" onMouseOver="javascript:dispRegHelp(this.name);">
				        </div>
				    ...
				    <div id="reg_formline">
				        ...
				        <div id="reg_forminput">
				            <input type="text" class="input" name="user_email" size="50" value="<?echo $this->post['user_email'];?>" onMouseOver="javascript:dispRegHelp(this.name);">
				        </div>
				        <div id="reg_formclear"></div>
				    </div>
				    ...
				    <div id="reg_formline">
				        ...
				        <div id="reg_forminput">
				            <input type="text" class="input" name="user_email_val" size="50" value="<?echo $this->post['user_email_val'];?>" onMouseOver="javascript:dispRegHelp(this.name);">
				        </div>
				        <div id="reg_formclear"></div>
				    </div>
				    ...
				    <div id="reg_formline">
				        ...
				        <div id="reg_forminput">
				            <input type="text" class="input" name="user_fname" size="50" value="<?echo $this->post['user_fname'];?>" onMouseOver="javascript:dispRegHelp(this.name);">
				        </div>
				        <div id="reg_formclear"></div>
				    </div>
				    ...
				    <div id="reg_formline">
				        ...
				        <div id="reg_forminput">
				            <input type="text" class="input" name="user_lname" size="50" value="<?echo $this->post['user_lname'];?>" onMouseOver="javascript:dispRegHelp(this.name);">
				        </div>
				        <div id="reg_formclear"></div>
				    </div>
