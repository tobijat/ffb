...
<div id="Container">
	...
	<!--/div-->		
       ...
       if($this->numComments>0) { ?>
        <a href="javascript:void(0);" onclick="javascript:getComments('bestteam', null);return;" style="font-size:80%;">alle <?php  echo $this->numTotalComments; ?> Community Meinungen anzeigen</a>
        <?php }}else {
