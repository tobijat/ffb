...
?>
  ...
  <script type="text/javascript" src="<?php echo FFB_BASE_PATH.SCRIPT_PATH?>prototype.js"></script>
	...
	<script type="text/javascript" src="<?php echo FFB_BASE_PATH.FFB_SCRIPT_PATH?>bestteam_v2.js"></script>
...
<body onLoad="javascript:initMyteam(<?echo $this->session->user_id?>);">
	...
	<!--/div-->		
        ...
        <div class="userComment" id="comment_box">
          ...
          <div class="userCommentFooter">
            <input class="commentButton" type="button" onclick="javascript:addComment('bestteam', null);" value="Meinung teilen"/>
          </div>
        </div>
        <?
          $index  = 0;
       ...
       if($this->numComments>0) { ?>
        <a href="javascript:void(0);" onclick="javascript:getComments('bestteam', null);return;" style="font-size:80%;">alle <? echo $this->numTotalComments; ?> Community Meinungen anzeigen</a>
        <?}}else {
